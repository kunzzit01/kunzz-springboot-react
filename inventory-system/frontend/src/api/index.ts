...
export const deleteFreezerCategory = (id: number, force?: boolean) =>
  http.delete<unknown, { success: boolean; name: string; cleared: number }>('/stock/freezer-categories/' + id, {
