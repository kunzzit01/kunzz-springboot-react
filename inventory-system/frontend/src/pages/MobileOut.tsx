...
/**
 * 电话版出货（对齐旧系统 /mobile/ch/stocklistjX.php「库存列表 (JX)」，路由 /mobile/out?system=jX）
 ...
 *   双层校验见 utils/useMobileAccess（branch + 权限树）。
 */
...
export default function MobileOut() {
  ...
  // 双层权限（branch + 权限树）+ 当前用户（receiver 用）
